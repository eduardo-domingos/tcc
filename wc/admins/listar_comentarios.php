        ...
        <section class="container" id="listar_projetos">
            ...
            <form name="buscar" action="#" method="GET">
                <section class="form-group">
                    <center>
                        ...
                        <input class="form-control container2" type="text" name="busca" placeholder="Digite o nome da pessoa" autocomplete="off" required>    
            ...
            <section>
                <?php
                    ...
                    if(isset($_GET['pesquisar'])){
                        ...
                        if(empty($busca)){
                            echo('<script>window.alert("Preencha o campo!");window.location="listar_comentarios.php";</script>');
                        }else{

                            #$sql = 'SELECT * FROM livros WHERE nome LIKE "'.$busca.'%";';
                            $sql = 'SELECT * FROM comentarios WHERE nome LIKE "%'.$busca.'%";';
                            ...
                            if($linhas == 0) echo('<script>window.alert("Comentario não encontrado!");window.location="listar_comentarios.php";</script>');
                        }
                    }
                    else{
            ...
            <section class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tr>
                            <td><?php echo $id_comentario ?></td>
                            <td><?php echo $id_projeto ?></td>
                            <td><?php echo $id_usuario ?></td>
                            <td><?php echo $nome ?></td>
                            <td><?php echo $comentario ?></td>
                            <td><?php echo $data_coment ?></td>

                        <td>
                            <a class="btn btn-warning btn-sm" href="editar_comentarios.php?id_comentario=<?php echo $id_comentario ?>&id_usuario =<?php echo $id_usuario ?>" role="button">
                                <img class="icones" src="../icons/pencil.png" name="Editar" value="Editar">&nbsp;Editar
                            </a>

                            <a class="btn btn-danger btn-sm botao_excluir" href="deletar_comentario.php?id_comentario=<?php echo $id_comentario ?>&id_usuario=<?php echo $id_usuario ?>" role="button">
